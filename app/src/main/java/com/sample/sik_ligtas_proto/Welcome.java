...
public class Welcome extends AppCompatActivity {
    ...
    private void prompt() {
        ...
        wel_login.setOnClickListener(view -> startActivity(new Intent(Welcome.this,Login.class)));
        wel_signup.setOnClickListener(view -> startActivity(new Intent(Welcome.this,Register.class)));
    }
